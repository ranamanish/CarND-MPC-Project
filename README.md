...
**Model Predictive Control (MPC)** *Rubic Points*
 ...
 - In the current implementation the delay is already introduced. The State of the vehicle is updated baed on the current speed, position, acceleration and orientation change by 100 ms.
